...
headers = {
  ...
  'Referer' : 'https://www.seethroughny.net/payrolls/122686'
}
...
df.to_csv(r'/Users/catherineng/Desktop/Python Projects/editors2018A.csv', sep=',', encoding='utf-8-sig', index=False)
