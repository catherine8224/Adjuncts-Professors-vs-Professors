...
headers = {
  ...
  'Referer' : 'https://www.seethroughny.net/payrolls/122680'
}

data = {
    'PayYear[]' : '2016',
    'PositionName[]' : 'Professor',
    #'BranchName[]': 'State - Executive',
    'SortBy': 'YTDPay DESC', 
    'current_page' : '0',
    'result_id' : '122680970',
...
df.to_csv(r'/Users/catherineng/Desktop/Python Projects/editors2016.csv', sep=',', encoding='utf-8-sig', index=False, header=False)
