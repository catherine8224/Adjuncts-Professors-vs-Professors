...
'Referer' : 'https://www.seethroughny.net/payrolls/122660'
}

data = {

  'PayYear[]' : '2018',
  #'BranchName[]': ['State - Executive', 'New York City'],
...
df.to_csv(r'/Users/catherineng/Desktop/Python Projects/editors2018.csv', sep=',', encoding='utf-8-sig', index=False)
